 ...
 */
public class TscpDefaultScheduler implements ITscpScheduler{
	
	
	private static ITscpScheduler tscpScheduler ;
	
	private Scheduler scheduler;
	
	private TscpDefaultScheduler() throws SchedulerException {
		super();
	 ...
	 * @throws SchedulerException 
	 */
	public synchronized static ITscpScheduler getDefaultInstance() throws SchedulerException{
		
		if(tscpScheduler == null)
			tscpScheduler = new TscpDefaultScheduler();
		
		return tscpScheduler;
	}

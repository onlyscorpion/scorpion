...
import org.scorpion.api.persistence.AbsTscpResultHandler;
import org.scorpion.api.persistence.ITscpResultHandler;
 ...
 */
public class TscpPersistenceDAO extends AbsPersistenceQueryDao{
	...
	public <T extends AbsTscpBasePo> T queryPoBykey(String key, DBParam param, Class<T> clazz)throws TscpBaseException {
		...
		try{
			...
			throw new TscpBaseException("TSCP-9087:QUERY DATA BY PO EXCEPTION",e);
		}
	}
	...
	public <T extends AbsTscpBasePo> List<T> queryLisPoByKey(String key, DBParam param,Class<T> clazz) throws TscpBaseException {
		...
		try{
			...
			throw new TscpBaseException("TSCP-9087:Query POJO list exception !",e);
		}
	}
	...
	public <T extends AbsTscpBasePo> T queryPoBySQL(String sql, DBParam param, Class<T> clazz)throws TscpBaseException {
			...
			try {
				...
				throw new TscpBaseException("TSCP-9086:Query POJO by SQL failure !",e);
			}	
	}
	...
	public <T> T queryDataBySQL(String sql, DBParam param,ITscpResultHandler<T> handler) throws TscpBaseException {
		...
		if(handler == null)
			throw new TscpBaseException("TSCP-8954:The parameter [ITscpResultHandler]can't be null !");
	
		try{
			return queryDataSuperDao(sql,param,handler);
		}catch(Throwable ex){
			throw new TscpBaseException("TSCP-9087:Query data by SQL failure !",ex);
		}
	...
	@Override
	public int updateDataBySQL(String sql, String[] tables,DBParam param) throws TscpBaseException {
	
		try {
			return super.doExecuteSuper(sql, param);
		} catch (SQLException e) {
			throw new TscpBaseException("TSCP-9468:Update data by SQL failure !",e);
		}
	}
	...
	@Override
	public int updateDataByKey(String sqlKey, DBParam param)throws TscpBaseException {
		...
		try{
			...
			throw new TscpBaseException("TSCP-8907:Update data by SQL KEY failure !", ex);
		}
	}
	...
	@Override
	public boolean insertPo(AbsTscpBasePo po) throws TscpBaseException {
		...
		try{
			...
			if(sqlproperty == null)
				throw new TscpBaseException("TSCP-9087:PO["+po.getClass().getName()+"] invalidate !");
			
			return this.doInsertPo(po,poProperty,sqlproperty.getVaule());
		}catch(Throwable ex){
			throw new TscpBaseException("TSCP-9089:Insert data by Po["+po.getClass().getName()+"] failure !",ex);
		}
	}
	...
	@Override
	public int[] insertPos(Collection<? extends AbsTscpBasePo> pos)throws TscpBaseException {
		...
		try{
			...
			if(sqlproperty == null)
				throw new TscpBaseException("TSCP-9087:PO["+pos.iterator().next().getClass().getName()+"] invalidate !");
			return this.doInsertPos(pos,poProperty,sqlproperty.getVaule());
		}catch(Throwable ex){
			throw new TscpBaseException("TSCP-9836:Insert batch data information by pos failure !",ex);
		}
	}
	...
	@Override
	public int updatePO(AbsTscpBasePo po) throws TscpBaseException {
	...
	@Override
	public int updatePOs(Collection<? extends AbsTscpBasePo> pos)throws TscpBaseException {
	...
	@Override
	public boolean deletePO(AbsTscpBasePo po) throws TscpBaseException {
		...
		try{
			...
			throw new TscpBaseException("TSCP-6987:Delete POJO exception !",ex);
		}
	}

	@Override
	public int[] deletePOs(Collection<? extends AbsTscpBasePo> pos)throws TscpBaseException {
		...
		try{
			...
			throw new TscpBaseException("TSCP-9848: Delete batch data by POJO failure !",ex);
		}
	}
	...
	@Override
	public boolean executeSQLByKey(String sqlKey, DBParam param)throws TscpBaseException {
		
		try{
			SQLProperty sqlProperty = sqlManager.getSQLByKey(sqlKey,param);
			return super.doExecuteByParams(sqlProperty.getVaule(), param);
		}catch(Throwable ex){
			throw new TscpBaseException("TSCP-7945:Execute SQL by SQL key failure !",ex);
		}
	}
	...
	@Override
	public int[] executeBatchByKey(String sqlKey, Collection<DBParam> params)throws TscpBaseException {
		
		try{
			if(!SystemUtils.collectionIsNotNull(params))
				throw new TscpBaseException("TSCP-9076:执行sqlKey["+sqlKey+"]sql异常 !");
			...
			throw new TscpBaseException("TSCP-9846:Execute batch SQL by SQL key failure !",ex);
		}
	}
	...
	@Override
	public List<Map<String,Object>> executeProcedureByKey(String procedureKey,DBParam param) throws TscpBaseException {
	...
	public List<Map<String,Object>> queryLisMapBySQL(String sql, DBParam param)throws TscpBaseException {
		...
		try{
			return queryDataSuperDao(sql,param,new AbsTscpResultHandler<List<Map<String,Object>>>() {
				@Override
	...
	@Override
	public Object queryColumnByKey(String sqlKey, DBParam param, final int indexcolumn)throws TscpBaseException {
	
		try{
			SQLProperty sqlproperty = sqlManager.getSQLByKey(sqlKey,param);
			return queryDataSuperDao(sqlproperty.getVaule(),param,new AbsTscpResultHandler<Object>() {
			...
			throw new TscpBaseException("TSCP-6946:Query database column by key failure !",e);
		}
	}
	...
	@Override
	public List<Object> queryColumnListByKey(String sqlKey, DBParam param,final int indexcolumn) throws TscpBaseException {
	
		try{
			SQLProperty sqlproperty = sqlManager.getSQLByKey(sqlKey,param);
			return queryDataSuperDao(sqlproperty.getVaule(),param,new AbsTscpResultHandler<List<Object>>() {
				@Override
			...
			throw new TscpBaseException("TSCP-6946:Query database column List by key failure !",e);
		}
	}
	...
	@Override
	public void executeProcedure(String procedure, DBParam param)throws TscpBaseException {
	...
	public void rollback() throws TscpBaseException {
		try {
			...
			throw new TscpBaseException("TSCP-7864:There is a exception in rollback transaction !",e);
		}
	}


	@Override
	public void executeFunction(String function, DBParam param)throws TscpBaseException {
	...
	@Override
	public List<Map<String, Object>> executeFunctionByKey(String functionKey,DBParam param) throws TscpBaseException {
	...
	@Override
	public boolean deleteDataByKey(String sqlKey, DBParam param) throws TscpBaseException {
	...
	@Override
	public List<Map<String, Object>> queryListMapByPaging(String sqlKey,DBParam param, int startnum, int endnum) throws TscpBaseException {
	...
	public <T extends AbsTscpBasePo> List<T> queryListPoByPaging(String sqlKey,DBParam param,int startnum,int endnum, Class<T> clazz) throws TscpBaseException {
		...
		try{
			...
			throw new TscpBaseException("TSCP-9857:Query List Po information failure !",ex);
		}
	}
	...
	@Override
	public boolean insertDataByKey(String key, DBParam param)throws TscpBaseException {

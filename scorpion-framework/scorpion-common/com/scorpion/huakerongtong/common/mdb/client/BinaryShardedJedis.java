...
import com.scorpion.huakerongtong.common.mdb.client.util.Hashing;
import com.scorpion.huakerongtong.common.mdb.client.util.Sharded;

public class BinaryShardedJedis extends Sharded<ScorpionRDClient, JedisShardInfo>
    ...
    for (ScorpionRDClient jedis : getAllShards()) {
        jedis.quit();
        jedis.disconnect();
    }
    }

    protected ScorpionRDClient create(JedisShardInfo shard) {
	return new ScorpionRDClient(shard);
    }

    public String set(byte[] key, byte[] value) {
	ScorpionRDClient j = getShard(key);
    ...
    public byte[] echo(byte[] arg) {
        ScorpionRDClient j = getShard(arg);
        return j.echo(arg);
    }

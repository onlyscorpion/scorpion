 ...
 */
public class TscpDataCipherChannelHandler {
	...
	public static byte[] cipherEncryptDataHandler(byte[] data, int off,int len, String key, String algorithm) throws Exception {
		...
		ABigDataDecoderPipeline cipherPrimer = TscpSecurityFactory.getDataDecoder(SecurityEnum.DecoderAlgorithmType.DES.name());

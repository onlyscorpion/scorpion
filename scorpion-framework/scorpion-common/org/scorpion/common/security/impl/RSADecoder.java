 ...
 */
public class RSADecoder extends ABigDataDecoderPipeline {
	 ...
	 * @throws Exception
	 */
	private RSADecoder() throws Exception {
	...
	public String signMessage(String data, String key) throws Exception {
		...
		Signature s = Signature.getInstance(this.RSAWITHMD5);
	...
	public synchronized static ABigDataDecoderPipeline getInstance()throws Exception {
		...
		if (dsaDecoder == null)
			dsaDecoder = new RSADecoder();
		return dsaDecoder;
	}

	private static RSADecoder dsaDecoder;

 ...
 */
public interface ITscpSecurity {
	 ...
	 */
	public String signMessage(String data, String key) throws TscpBaseException;
	 ...
	 * @throws TscpBaseException
	 */
	public boolean validate(String data, String key, String sign)throws TscpBaseException;

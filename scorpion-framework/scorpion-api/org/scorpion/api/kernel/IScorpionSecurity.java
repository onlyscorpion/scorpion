 ...
 */
public interface IScorpionSecurity {
	 ...
	 */
	public String signMessage(String data, String key) throws ScorpionBaseException;
	 ...
	 * @throws ScorpionBaseException
	 */
	public boolean validate(String data, String key, String sign)throws ScorpionBaseException;

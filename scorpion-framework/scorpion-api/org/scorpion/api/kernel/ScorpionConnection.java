...
import org.scorpion.api.persistence.IScorpionConnection;
 ...
 */
public class ScorpionConnection implements IScorpionConnection, Serializable{
	...
	public ScorpionConnection(Connection connetion,Integer dbType,boolean isOpenTrasaction,boolean isCommitTransaction) throws ScorpionBaseException {
		super();
		try {
			...
			throw new ScorpionBaseException("scorpion-9065:Create database conneciton failure !",e);
		}
	}

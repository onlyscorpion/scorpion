 ...
 */
public interface IScorpionServiceContainer {
	
	/**
	 * @Description Register service container ...
	 * 
	 * @throws ScorpionBaseException
	 */
	public void registerServiceContainer() throws ScorpionBaseException;
	
	
	/**
	 * @Description Destroy service container ...
	 * 
	 * @throws ScorpionBaseException
	 */
	public void destroyServiceContainer() throws ScorpionBaseException;

...
import com.scorpion.huakerongtong.api.log.ScorpionLogFactory;
...
public class ClassUtils {
	...
	// =========================================Javassist代码编译器====开始============================================================//
	/**
	 * 向Javassist的ClassPool中增加类路径
	 * 
	 * @Description 向Javassist的ClassPool中增加类路径，处理无法找到类的问题
	...
	/**
	 * 从Javassist的ClassPool中删除类路径
	 * 
	 * @Description 从Javassist的ClassPool中删除类路径，用于保持ClassPool干净，使得编译速度得到保证
	 * @Time 创建时间:2011-8-30下午2:55:16
	 * @param clazz
	 * @param loader
	 * @throws ScorpionBaseException
	 ...
	 *              <P>
	 *              因为JDK的编译器编译速度较慢，所以目前使用Jboss Javassist进行源代码编译<br>
	...
	public static Class<?> generateDynamicClassByJDK(ClassLoader classloader, String className, String code)
		...
		// 非生产模式下输出要编译的源代码
		if (errorMsg.length() > 1 && !Boolean.parseBoolean(SystemContext.getApplicationContext().getSystemCoreConfig().getRunModel())) {
	 ...
	 * 获取数组对象维度
	 * 
	 * @Description 获取数组对象维护度以及第一维的实际长度<br>
	...
	public static void checkSerializable(Object obj, String debugMsg) throws ScorpionBaseException {
		...
		if (!Boolean.parseBoolean(SystemContext.getApplicationContext().getSystemCoreConfig().getRunModel()) ) {
			return;
		}
	 ...
	 * 
	 * @Description 相关说明
	 * @Time 创建时间:2012-12-20上午10:31:20
	 * @param method
	 * @return
	 * @history 修订历史（历次修订内容、修订人、修订时间等）
	 */
	 ...
	 * 
	 * @Description 相关说明
	 * @Time 创建时间:2012-12-20上午10:32:51
	 * @param field
	 * @return
	 * @history 修订历史（历次修订内容、修订人、修订时间等）
	 */
	 ...
	 * 
	 * @Description 相关说明
	 * @Time 创建时间:2012-12-20上午10:46:37
	 * @param mod
	 * @return
	 * @history 修订历史（历次修订内容、修订人、修订时间等）
	 */

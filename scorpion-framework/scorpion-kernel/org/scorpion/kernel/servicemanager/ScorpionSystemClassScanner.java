 ...
 */
public class ScorpionSystemClassScanner implements IScorpionSystemClassScanner {

	@Override
	public void doAnnotationAnalyzerChain(Class<?> clazz, String jarName)throws ScorpionBaseException {

		for (IAnnotationAnalyzerListener analyzer : IScorpionSystemClassScanner.annotationAnalyzers)
	...
	public void registerAnnotationAnalyzer(IAnnotationAnalyzerListener annotationAnalyzer)throws ScorpionBaseException {
		...
		IScorpionSystemClassScanner.annotationAnalyzers.add(annotationAnalyzer);
